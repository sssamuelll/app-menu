...
const PinDigit: React.FC<IPinDigitProps> = (props: IPinDigitProps) => {
  ...
  React.useEffect(() => {
    if (props.value) {
      const timeout: typeof interval = setTimeout(() => {
        setHiddenTo(true);
      }, 500);
...
const Pin: React.FC = () => {
  ...
  }, [pin, setUserStatusTo, userStatus]);
    ...
    <div id="app-menu">
      <div id="app-menu-content-wrapper">
        <div id="app-menu-content">
          ...
          <QuickNav />
          <a id="youtube-link" className="clear-button" href="https://www.youtube.com/c/Hyperplexed?sub_confirmation=1" target="_blank" rel="noreferrer">
